...
void editfuncionariosTXT() {
    ...
    while (fgets(linha, sizeof(linha), arquivo) != NULL) {
        ...
        if (sscanf(linha, " %d, %99[^,], %14[^,], %49[^,], %f", &funcionario.id, funcionario.nome, funcionario.cpf, funcionario.cargo, &funcionario.salario) == 5) {
            if (strcmp(funcionario.cpf, cpf) == 0) {
                encontrado = 1;
                printf("Funcionário encontrado! Digite os novos dados.\n");
                printf("ID:", funcionario.id);
                printf("Nome: ");
                scanf(" %99[^\n]", funcionario.nome);
                printf("Cargo: ");
                scanf(" %49[^\n]", funcionario.cargo);
...
void lerfuncionariosTXT() {
    ...
    while (fgets(linha, sizeof(linha), arquivo)) {
        ...
        (sscanf(linha, " %d, %99[^,], %14[^,], %49[^,], %f", &funcionario.id, funcionario.nome, funcionario.cpf, funcionario.cargo, &funcionario.salario) == 4);
            printf("ID: %d\nNome: %s\nCPF: %s\nCargo: %s\nSalário: %.2f\n", 
                funcionario.id, funcionario.nome, funcionario.cpf, funcionario.cargo, funcionario.salario);
            printf("--------------------------------------------------------------------------------------\n");
    }
