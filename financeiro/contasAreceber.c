...
void regContaReceber() {
    ...
    conta.dataRecebido = 0;  //  não recebido
    conta.recebido = 0;      // pendente
...
void baixarContaReceberBin() {
    int codigo;
    printf("Digite o código da conta que deseja baixar: ");
    scanf("%d", &codigo);
...
void baixarContaReceber() {
    ...
    if (formatoReg == 1) {
        baixarContaReceberBin();
    } else {
        baixarContaReceberTxt();
    }
}
...
void excluirContasReceber() {
    ...
    if (formatoReg == 1) {
        excluirContasReceberBin();
    } else {
        excluirContasReceberTxt();
    }
}
